...
class ItemList extends Pizzahut
{
    void itemList(Test order,int i)throws IOException
    {
        ...
        System.out.println("Do you want to use the offer? 1-yes 2-No");
...
class Test extends ItemList {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Enter the type of order:\n1.Sit in order\n2.Take away order\n3.Bill");
        {
            ...
            if (k == 1)
            {
                System.out.println("Do you want salad? 1-yes 2-NO");
                k = Integer.parseInt(in.readLine());
                if(k == 1)
                {
                    System.out.println("Enter\n1.Green leafy salad\n2.Vegetable salad\n3.Fruit salad");
...
//        LocalDateTime now = LocalDateTime.now();
        ...
        {
            System.out.println("Sorry! You haven't purchased any products");
        }
    }
}